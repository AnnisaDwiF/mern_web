    ...
    <div>
        <section id="Skills">
            <div className="container">
                ...
                <div className="card p-3 me-4 mb-4" style={{ width: "198px", height: "143px", border: "1px solid #D4D4D4",borderTopRightRadius:"16px", borderRadius: "0px",marginLeft: "-10px"}}>
                  <div className="card-body text-left" style={{fontSize: "11px", fontWeight: "bold"}}>
                ...
                <div className="card p-3 me-4 mb-4" style={{ width: "156px", height: "143px", border: "1px solid #D4D4D4", borderBottomLeftRadius: "16px", borderTopLeftRadius: "16px",  marginLeft: "230px"}}>
                  <div className="card-body text-left" style={{fontSize: "11px", fontWeight: "bold"}}>
                ...
                <div className="card p-3 me-4 mb-4" style={{ width: "156px", height: "143px", border: "1px solid #D4D4D4", borderBottomRightRadius: "16px", borderTopRightRadius: "0px", borderRadius : "0px", marginLeft: "-10px"}}>
                  <div className="card-body text-left" style={{fontSize: "11px", fontWeight: "bold"}}>
